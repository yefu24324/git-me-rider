...
export type HoverCardTriggerProps<T extends ValidComponent = "button"> = ComponentProps<typeof HoverCardPrimitive.Trigger<T>>;

export const HoverCardTrigger = <T extends ValidComponent = "button">(props: HoverCardTriggerProps<T>) => {
  return <HoverCardPrimitive.Trigger data-slot="hover-card-trigger" {...props} />;
};

export type HoverCardContentProps<T extends ValidComponent = "div"> = ComponentProps<typeof HoverCardPrimitive.Content<T>>;

export const HoverCardContent = <T extends ValidComponent = "div">(props: HoverCardContentProps<T>) => {
