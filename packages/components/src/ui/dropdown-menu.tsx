...
export type DropdownMenuTriggerProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.Trigger<T>>;

export const DropdownMenuTrigger = <T extends ValidComponent = "div">(props: DropdownMenuTriggerProps<T>) => {
  return <DropdownMenuPrimitive.Trigger data-slot="dropdown-menu-trigger" {...props} />;
};

export type DropdownMenuGroupProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.Group<T>>;

export const DropdownMenuGroup = <T extends ValidComponent = "div">(props: DropdownMenuGroupProps<T>) => {
...
export type DropdownMenuRadioGroupProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.RadioGroup<T>>;

export const DropdownMenuRadioGroup = <T extends ValidComponent = "div">(props: DropdownMenuRadioGroupProps<T>) => {
  return <DropdownMenuPrimitive.RadioGroup data-slot="dropdown-menu-radio-group" {...props} />;
};

export type DropdownMenuSubTriggerProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.SubTrigger<T>> & {
  inset?: boolean;
};

export const DropdownMenuSubTrigger = <T extends ValidComponent = "div">(props: DropdownMenuSubTriggerProps<T>) => {
...
export type DropdownMenuSubContentProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.SubContent<T>>;

export const DropdownMenuSubContent = <T extends ValidComponent = "div">(props: DropdownMenuSubContentProps<T>) => {
...
export type DropdownMenuContentProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.Content<T>>;

export const DropdownMenuContent = <T extends ValidComponent = "div">(props: DropdownMenuContentProps<T>) => {
...
export type DropdownMenuItemProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.Item<T>> & {
  inset?: boolean;
  variant?: "default" | "destructive";
};

export const DropdownMenuItem = <T extends ValidComponent = "div">(props: DropdownMenuItemProps<T>) => {
...
export type DropdownMenuCheckboxItemProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.CheckboxItem<T>>;

export const DropdownMenuCheckboxItem = <T extends ValidComponent = "div">(props: DropdownMenuCheckboxItemProps<T>) => {
  ...
  return (
    ...
    >
      <span class="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator as="svg" class="size-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export type DropdownMenuRadioItemProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.RadioItem<T>>;

export const DropdownMenuRadioItem = <T extends ValidComponent = "div">(props: DropdownMenuRadioItemProps<T>) => {
  ...
  return (
    ...
    >
      <span class="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator as="svg" class="size-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export type DropdownMenuGroupLabelProps<T extends ValidComponent = "span"> = ComponentProps<typeof DropdownMenuPrimitive.GroupLabel<T>> & {
  inset?: boolean;
};

export const DropdownMenuGroupLabel = <T extends ValidComponent = "span">(props: DropdownMenuGroupLabelProps<T>) => {
...
export type DropdownMenuItemLabelProps<T extends ValidComponent = "div"> = ComponentProps<typeof DropdownMenuPrimitive.ItemLabel<T>> & {
  inset?: boolean;
};

export const DropdownMenuItemLabel = <T extends ValidComponent = "div">(props: DropdownMenuItemLabelProps<T>) => {
...
export type DropdownMenuSeparatorProps<T extends ValidComponent = "hr"> = ComponentProps<typeof DropdownMenuPrimitive.Separator<T>>;

export const DropdownMenuSeparator = <T extends ValidComponent = "hr">(props: DropdownMenuSeparatorProps<T>) => {
  const [, rest] = splitProps(props as DropdownMenuSeparatorProps, ["class"]);

  return <DropdownMenuPrimitive.Separator class={cx("bg-border -mx-1 my-1 h-px", props.class)} data-slot="dropdown-menu-separator" {...rest} />;
};
...
export const DropdownMenuShortcut = (props: DropdownMenuShortcutProps) => {
  ...
  return <span class={cx("text-muted-foreground ml-auto text-xs tracking-widest", props.class)} data-slot="dropdown-menu-shortcut" {...rest} />;
};
